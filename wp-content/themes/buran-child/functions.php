...
add_action( 'wp_enqueue_scripts', 'buranchild_scripts' );
function buranchild_scripts() {
	wp_enqueue_style( 'buran-parent-style', get_template_directory_uri() . '/style.css', array('bootstrap-css') );
    wp_enqueue_style( 'buran-child-style', get_stylesheet_uri() );
}
